(ns loicb.server.core
  (:require [loicb.server.core.handler :as handler]
            [loicb.server.core.handler.operation.db :as db]
            [loicb.server.core.init-data :as sample]
            [aleph.http :as http]
            [clojure.edn :as edn]
            [datalevin.core :as d]
...
(def oauth2-default-config
  {:google
   {:project-id       "loicb-website"
    :scopes           ["https://www.googleapis.com/auth/userinfo.email" "https://www.googleapis.com/auth/userinfo.profile"],
    :redirect-uri     "https://loicb.sg/oauth/google/callback",
